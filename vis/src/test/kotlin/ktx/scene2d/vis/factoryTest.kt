...
class NoInitBlockActorFactoriesTest : NeedsLibGDX() {
  ...
  @Test
  fun `should create VisLabel`() = test(
  ...
  @Test
  fun `should create VisList with items`() = test(
  ...
  @Test
  fun `should create VisSelectBox with items`() = test(
...
class InlinedInitBlockActorFactoriesTest : NeedsLibGDX() {
  ...
  @Test
  fun `should create VisImage with texture`() = test {
    visImage(VisUI.getSkin().getRegion("button").texture) { color = Color.BLUE }
  }

  @Test
  fun `should create VisImage with texture region`() = test {
