 ...
 */
inline fun <reified T> TiledMapTile.property(key: String, defaultValue: T): T = this.properties[key, defaultValue, T::class.java]
 ...
 */
inline fun <reified T> TiledMapTile.propertyOrNull(key: String): T? = this.properties[key, T::class.java]

/**
 * Extension method to directly access the [MapProperties] of a [TiledMapTile] and its [containsKey][MapProperties.containsKey] method
 * @param key property name
