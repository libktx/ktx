 ...
 */
inline fun <reified T> MapLayer.property(key: String): T = this.properties[key, T::class.java]
    ?: throw MissingPropertyException("Property $key does not exist for layer ${this.name}")
