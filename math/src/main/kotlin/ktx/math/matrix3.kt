 ...
 * @see Matrix3.mulLeft
 */
operator fun Matrix3.timesAssign(matrix3: Matrix3) { this.mul(matrix3) }

/**
 * @param scalar scales the matrix in the both the x and y components.
 */
operator fun Matrix3.timesAssign(scalar: Float) { this.scl(scalar) }

/**
 * @param scale scales the matrix in the both the x and y components.
 */
operator fun Matrix3.timesAssign(scale: Vector2) { this.scl(scale) }
